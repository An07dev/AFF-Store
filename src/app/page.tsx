          ...
          <div className={styles.rareHeaderContainer}>
            <div className={styles.rareHeaderInner}>
              <div className={styles.rareLogoWrap}>
                <Link href="/" className={styles.rareLogoLink} style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <section className={styles.container}>
          <div className={styles.ctaBanner}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: 14, flexWrap: 'wrap' }}>
              ...
              <CoolMode options={{ particle: "✨" }}>
                <Link href="/demo" target="_blank" rel="noopener noreferrer" className={`${styles.btnSecondary} ${styles.btnHeroSecondary}`}>
            ...
            <div className={styles.footerGrid}>
              ...
              <div>
                ...
                <ul className={styles.footerColLinks}>
                  <li><Link href="/demo" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>Trang Chủ Mua Sắm ↗</Link></li>
                  <li><Link href="/demo?tab=products" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>Tất Cả Sản Phẩm ↗</Link></li>
                  <li><Link href="/demo?tab=categories" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>Danh Mục Hàng ↗</Link></li>
